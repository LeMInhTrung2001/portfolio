...
export const ProjectDetails = ({title, description, subDescription, image, tags, href, closeModal}) => {
  return (
    <div 
      onClick={closeModal}
    ...
    >
      <motion.div 
        className='relative max-w-2xl border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10 max-h-[90vh] overflow-y-auto custom-scrollbar-hide'
          ...
          <div className='flex items-center justify-between mt-4'>
            ...
            {href ? (
              ...
              >
                ...
                <span className='text-neutral-500'>Project nearing completion</span>
            )}
          </div>
        </div>
      </motion.div>
